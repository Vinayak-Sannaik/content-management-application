  ...
  return (
    <div className="group relative bg-white dark:bg-gray-800 rounded-lg shadow-md overflow-hidden transition-all duration-300 hover:shadow-lg">
      <div className="aspect-h-1 aspect-w-1 w-full overflow-hidden rounded-t-lg bg-gray-200">
        <Image
          src={product.image}
          alt={localizedProduct.name[locale]}
      ...
      <div className="p-4">
        <h3 className="text-lg font-medium text-gray-900 dark:text-white">{localizedProduct.name['en']}</h3>
        <p className="mt-1 text-gray-500 dark:text-gray-400 line-clamp-2">{localizedProduct.description['en']}</p>
